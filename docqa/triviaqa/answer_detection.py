...
from read_data import TriviaQaQuestion
...
def compute_answer_spans(questions: List[TriviaQaQuestion], corpus, word_tokenize,
    ...
    for i, q in enumerate(questions):
       # print('print question:',q.question)  
        if i % 500 == 0:
        ...
        #print("print tokenize",tokenized_aliases)
        ...
        for doc in q.all_docs:
            #print('each doc',doc)
            text = corpus.get_document(doc.doc_id) # don't work for all doc bugs!!
            if text is not None:
                #print('print corpus text',corpus.get_document(doc.doc_id))
