...
"""
#sys.path.append('C:/Users/boidiyv/Documents/tes_squad_model/document-qa-master')
...
"""def main_args():
    ...
    parser.add_argument(
        "--data_dir",
        type=Path,
        default=Path(__file__).absolute().parent / "docqa/squad",
...
def parse_squad_data(source, name, tokenizer, use_tqdm=True) -> List[Document]:
    #source= main_args()
   # source = "C:/Users/boidiyv/Documents/tes_squad_model/document-qa-master/docqa/squad/dev-v1.1.json"
    
    print('data source',source)
    #set_source("C:/Users/boidiyv/Documentstes_squad_model\document-qa-master\data")
